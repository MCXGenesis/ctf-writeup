...
A `Main.java` file was given. Let's open this java file to look for the flag.
...
## How to solve?
For this one, I think its's pretty obvious. I just need to basically read the characters written on the conditional statement that fits. So, without running, I got the flag ...
