...
## The challenge
Given `chall.zip`. When I extract it, there is `out.txt` that contains following:
...
## How to solve?
I am certainly sure that it is a base64 encoded text. With the hints of 'buried it alive', it
